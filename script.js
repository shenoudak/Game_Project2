var ghostEat_id=document.getElementById('ghostEat_id');
...
if(res==1){
	context.fillText("Pacman: winner" , 2, 18);
}
else if(res==2){
	context.fillText("Pacman: loser " , 2, 18);
}
else{
...
function gameOver(pac_score,ghost_gscore){
	...
	if(ghost_gscore-pac_score==differ_scre){
		console.log("Game Over or Pacman loser");		
		loser_id.play();
		score=0;
		gscore=0;
		return 2;
